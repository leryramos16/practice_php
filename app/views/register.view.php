  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-50 m-auto">
      <form action="" method="post">
        ...
        <?php if (!empty($data['usernameErr']) || !empty($data['emailErr']) || !empty($data['passwordErr']) || !empty($data['password2Err']) || !empty($data['agreeErr'])): ?>
        ...
        <small class="text-danger"><?= $password2Err ?></small>
    ...
    <script
      ...
      class="astro-vvvwv3sm">
        ...
        // Function to fade out element smoothly
        ...
        setTimeout(() => fadeOut(success), 3000);
        setTimeout(() => fadeOut(error), 3000);
    });

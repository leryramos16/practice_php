  ...
  <body class="d-flex h-100 text-center text-bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="mb-auto">
        <div>
          <h3 class="float-md-start mb-0">My PHP Practice</h3>
          <nav class="nav nav-masthead justify-content-center float-md-end">
            ...
            <a class="nav-link fw-bold py-1 px-0" href="<?=ROOT?>">Contact</a>
          </nav>
        </div>
      </header>
      <main class="px-3">
        <h1>Welcome to my Php Practice</h1>
        <p class="lead">
          This Website is only showing my practice in Php language! Hope i can make it!!!!
        </p>
        <p class="lead">
